...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
\paper{CAD designs of cavities and 3D printing by Maleeha Al-Hamadani}
\begin{frame}
  \frametitle{3D printing fetuses}
  \vspace{10pt}
        \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth]{./../figures/3d-printing/why-and-how/versions/drawing-v04.png}
        %\caption{}
      \end{figure}
...
\begin{frame}
  ...
  \vspace{10pt}
        \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{./../figures/3d-printing/souvenirs/versions/drawing-v01.png}
        %\caption{}
      \end{figure}
