...
\begin{frame}{Who am I?}
  ...
  \begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{./../figures/team/miguel-xochicale/versions/drawing-v03.png}
  \end{figure}
...
\begin{frame}{Who are we? / Where we come from? / Do we have hobbies?}
  ...
  \begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{./../figures/team/who-we-are/versions/drawing-v06.png}
  \end{figure}
