...
```
@INPROCEEDINGS{5578860,
  author={H. {Mori} and Y. {Kuniyoshi}},
  booktitle={2010 IEEE 9th International Conference on Development and Learning}, 
  title={A human fetus development simulation: Self-organization of behaviors through tactile sensation}, 
  year={2010},
  volume={},
  number={},
  pages={82-87},
  ...
  keywords={biomechanics;biomedical ultrasonics;bone;muscle;neurophysiology;obstetrics;physiological models;touch (physiological);human fetus development simulation;behavior self-organization;tactile sensation;ultrasound imaging;fetal intrauterine behavior;intrauterine learning;prenatal infants;leg movements;hand contact;face contact;nervous system;whole body fetal musculoskeletal model;arm movements;human like tactile distribution;Computational modeling;Pediatrics;Muscles;Neurons;Face;Indexes},
